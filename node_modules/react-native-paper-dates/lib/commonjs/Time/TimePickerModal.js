...
function TimePickerModal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_reactNative.Modal, {
    ...
    style: [styles.modalContent, {
      backgroundColor: theme.dark && theme.isV3 ? theme.colors.elevation.level3 : theme.isV3 ? theme.colors.surface : theme.dark ? (0, _reactNativePaper.overlay)(10, theme.colors.surface) : theme.colors.surface,
