...
import {addGreen, calendarTime, chat, gratitude, home} from '@assets/images';
import {ImageComponent} from '@components/image-component';
import {bottomTabs} from '@assets/constants';
import {TouchableOpacity} from 'react-native';
import {ModalRefProps} from '@components/modal-component';
import {AddComponentModal} from '@screens/home/add-component-modal';
  ...
  const renderTabs = (
    ...
    if (route.name === navigations.GRATITUDE) {
      return (
        <NavigatorOptionComponent
          focused={focused}
          selectedImage={gratitude}
          unSelectedImage={gratitude}
        />
      );
    }
    return null;
